using E_Healthcare_CapstoneProject_LMS.Data.Static;
        ...
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            ...
            using (var serviceScop = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Medicines.Any())
                {
                    ...
                    {
                        ImageCode = 13,
                        Name = "isotretonoin - 10 mg",
                        Description="benificial for cystic acne prone skin, reduces redness and swelling",
                        Price=64.1,
                        MedicineCategory=MedicineCategory.MedicineAndTreatment},
                     ...
                     new Medicine()
                    {
                        ...
                        Description="Antibiotic used to treat infection of lungs, ears, skin etc.",
                        Price=600,
                        MedicineCategory=MedicineCategory.MedicineAndTreatment},
                     ...
                     new Medicine()
                    {
                        ImageCode = 15,
                        Name = "Safi syrup",
                        Description="used for treating blood impurities",
                        Price=120,
                        MedicineCategory=MedicineCategory.MedicineAndTreatment}
